...
class _ExpensesState extends State<Expenses> {
  ...
  void _openAddExpenseOverlay([Expense? existingExpense]) {
                ...
                child: NewExpense(
                  onSubmit: (expense) {
                    if (existingExpense == null) {
                      ...
                      _updateExpense(existingExpense, expense);
                    }
                  },
  ...
  Widget build(BuildContext context) {
    ...
    if (_registeredExpenses.isNotEmpty) {
      mainContent = ExpensesList(
        ...
        onUpdateExpense: (oldExpense, newExpense) =>
            _openAddExpenseOverlay(oldExpense),
      );
    }
